                  ...
                  Expanded(
                    child: Container(
                      ...
                      child: InkWell(onTap: () {
                         ...
                         Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => const ShirtSearchScreen()),
                        );
                      },
                        child: Row(
                          children: [
...
import 'package:flutter_application_9/core/util/responsive_util.dart';
import 'package:flutter_application_9/features/home/presention/widgets/category_button.dart';
import 'package:flutter_application_9/features/home/presention/widgets/product_card.dart';
import 'package:flutter_application_9/features/home/presention/widgets/section_header.dart';
import 'package:flutter_application_9/widgets/custom_nav_bar.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      key: _scaffoldKey,
      backgroundColor: AppColors.scaffoldBg,
      drawer: const Drawer(child: SideMenuView()),
      ...
      child: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Expanded(child: CategoryButton(label: 'man', onTap: () {})),
                SizedBox(width: scale(context, 8)),
                Expanded(child: CategoryButton(label: 'woman', onTap: () {})),
                SizedBox(width: scale(context, 8)),
                Expanded(child: CategoryButton(label: 'child', onTap: () {})),
              ],
            ),
            SizedBox(height: scale(context, 20)),
            SectionHeader(title: 'Popular T-shirt', onSeeAllTap: () {}),
              ...
              builder: (context, snapshot) {
                ...
                return Row(
                  children: [
                    ...
                    SizedBox(width: scale(context, 12)),
                    Expanded(child: ProductCard(product: product2)),
                  ],
                );
              },
            ),
